...
function Input_Digit(digit) {
    ...
    //this checks if the Wait_Second_Operand is true we set Display_Value
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        ...
        //we want to add a deciaml poiint.
        Calculator.Display_Value += dot;
    }
}

//this sectioin handles operators
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator asleready exists and if Wait_Second_Operand is true,
    ...
    if (First_Operand == null) {
        ...
        //if oeprator exists, property lookup is performed for the operator
